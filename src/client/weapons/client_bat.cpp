...
std::vector<SDL2pp::Texture *> Bat::get_aim_textures(ResourcePool &pool) { return pool.get_worm_aiming(BAT); }

std::vector<SDL2pp::Texture *> Bat::get_attack_textures(ResourcePool &pool) { return pool.get_worm_attacking(BAT); }
