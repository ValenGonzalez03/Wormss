...
float MissileCallback::ReportFixture(b2Fixture* fixture, const b2Vec2& point,
...
bool MissileCallback::did_hit_wall() { return hit_a_wall; }

b2Vec2 MissileCallback::get_hit_point() { return hit_point; }
